 ...
 *  注册七牛获取
 */
static NSString *QiniuAccessKey        = @"44j5VjQZJgrDXeZbA4_-ii6edzqoCe_sGB8vNO7y";
static NSString *QiniuSecretKey        = @"-pHx3sCLD64GfjU2S7ZyOY0s4OxXqv8gvEcvWH18";
static NSString *QiniuBucketName       = kSpaceName;
